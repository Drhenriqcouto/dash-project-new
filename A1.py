...
def executar_operacao(valor, tipo_operacao, periodo, ativo_selecionado):
    ...
    for idx, row in df:
        ...
        if contador == 0 and (entrada_comprada - row['Mínima'] >= 0) and row['A1'] < 0:
        ...
        elif contador == 1 and entrada_vendida <= row['Máxima'] and row['A1'] > 0:
        ...
        elif contador == 2 and (entrada_vendida1 - row['Mínima'] >= 0) and row['A1'] < 0:
